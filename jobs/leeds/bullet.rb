...
class BulletXLS < PolyXLS
  def initialize
    @src_urls = %w(
      http://www.pcna.com/Bullet/contents/en-us/Documents/Downloads/WebDecorationMethodByItem.xls
      http://www.pcna.com/Bullet/contents/en-us/Documents/Downloads/Catalog.xls
    )
