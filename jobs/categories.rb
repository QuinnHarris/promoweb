...
[
     ...
     ['Candles',
      [match('name', 'candle'),
       sup('Lanco',
           ...
           cat('Food Gifts', 'Candles in Tins & Glass Jars') ) ]],
     ['Bath & Body Kits',
      [match('name', 'spa kit'),
       sup('Lanco', cat('Bath & Body', 'Bath & Body Kits') ) ]],
     ['Massagers',
      [match('name', 'massager') ]],
     ['Hand & Body Lotions',
      [sup('Lanco', cat('Bath & Body', 'Hand & Body Lotion') ) ]],
    ] ],
 ...
 ['Drinkware',
  [#match('name', %w(coffe))
   ...
   sup('High Caliber Line', match('name',%w(water tumbler mug canteen pitcher))),
   ...
   sup('Starline', cat('Drinkware', 'Vacuum Water Bottles') ),
     ...
     ['Mugs & Tumblers',
      [match('name', %w(tumbler mug), 1),
       ...
       sup('Lanco', cat('Food Gifts', 'Travel Mugs & Tumblers'),
           cat('Food Gifts', 'Mugs'))
      ],[
         ['Ceramic Coffee Mugs',
          [match('name', 'coffee', 1),
     ...
     ['Sport Bottles',
      [match('name', %w(bottle chill poly polly sports), 1),
       ...
       sup('ETS Express Inc', cat('h2go bottles') ),
       sup('Lanco', cat('Food Gifts', 'Sports Bottles') ),
 ...
 ['Food Gifts',
  [sup('Lanco',
       ...
       cat('Food Gifts', 'Gourmet Food Fills') ),
  ],[
     ['Lollipop',
     ...
     ['Gourmet Food Gifts',
      [sup('Lanco',
           ...
           cat('Food Gifts', 'Gourmet Food Gifts'),
           cat('Food Gifts', 'Gourmet Food Gifts & Tins'),
           cat('Food Gifts', 'Gourmet Food in Tins'),
           cat('Food Gifts', 'Gourmet Food in Jars'),
           ) ]],
     
     ['Gourmet Food Gift Baskets, Boxes & Trays',
      [sup('Lanco',
           cat('Food Gifts', 'Gourmet Food Gift Basket'),
           cat('Food Gifts', 'Gourmet Food in Tubs'),
           cat('Food Gifts', 'Food & Drinkware Gift Tray'),
           cat('Food Gifts', 'Food & Drinkware Gift Box'),
           cat('Food Gifts', 'Travel Mugs & Tumblers'),
           cat('Food Gifts', 'Sports Bottles'),
           cat('Food Gifts', 'Mugs') )
     ]],
      ...
      [],[
          ...
          ['Custom Molded Chocolate',
           [sup('Lanco',
                ...
                cat('Food Gifts', 'Custom Mold & Novelty Chocolate'),
                cat('Food Gifts', 'Custom Molded Chocolate') ) ]],
          ['Novelty Chocolate',
          ...
          ['Chocolate Gift Boxes & Sets',
           [sup('Lanco',
                ...
                cat('Food Gifts', 'Chocolate Squares in Gift Sets'),
                cat('Food Gifts', 'Chocolate Gifts')) ]],
         ]],
 ...
 ['Tools',
  [sup('Leeds', cat('Tools & Lighters', 'Tools') ),
   ...
   sup('The Magnet Group', cat('Innovations', 'Tools') )
     ...
     ['Bag Clips',
      [match('name', 'bag clip'),
       sup('Lanco', cat('Tools & Home Technology', 'Chip Clips') ),
       sup('Norwood',
    ...
    sup('Prime Line', cat('Writing Instruments') ),
     ...
     ['Pens',
      [match('name', /pens?($|\s)/i, 1),
       ...
       sup('High Caliber Line', match('name', /pen$/i)),
       sup('Lanco',
