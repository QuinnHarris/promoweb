     ...
     ['Computer Bags',
      [match('name', ['computer case', 'computer bag', 'laptop bag', 'laptop case']),
       ...
       supplier('Prime Line',
         ...
         dup('Bags', 'Business Bags', 'Computer Business Bags')
        ] ],
     ['Wheeled Bags',
      [match('name', 'wheel', 1),
       supplier('Gemline',
 ...
 ['Desktop Accessories',
  [supplier('Leeds',
   ...
   supplier('Bullet Line',
     ...
     ['Card Holders',
      [match('name', 'card holder', 1),
       ...
       supplier('Bullet Line',
                match('name', 'card case') )] ],
     ['Note Holders',
      [match('name', ['note holder', 'memo clip', 'memo holder', 'notenest'], 1),
       supplier('Lanco',
     ...
     ['Paper Clip Holders',
      [match('name', 'paper clip dispenser'),
       match('name', ['paper clip', 'cache'], 1),
       supplier('Lanco',
     ...
     ['Mind Games',
      [match('name', %w(suduko sudoku brain perplex mind))
         ...
         ['Puzzles',
          [match('name', 'puzzle'),
           supplier('Prime Line',
                    category('Magic Concepts&reg; Puzzles') ) ]],
         ['Rubiks Cubes',
          [match('name', 'rubik'),
           match('name', 'rubi', 1),
           supplier('Prime Line',
...
#   exclude(match('name', 'twill')),
 ...
 ['Health & Personal Care',
  [supplier('Gemline',
   ...
   supplier('High Caliber Line',
     ...
     ['Pedometers',
      [match('name', ['pedometer', 'step-meter']),
       supplier('Leeds',
                all(category('Outdoor Living', 'Excursion'),
     ...
     ['Dental Products',
      [match('name', ['floss', 'toothbrush', 'toothpick'])]],
     ['Pill Cases',
      [match(%w(name description), ['pill hold', 'pill case', 'pill box', 'pill tube']),
       supplier('Lanco',
 ...
 ['Personal Accessories',
  [
     ...
     ['Key Chains',
      [match(%w(name description), ['key chain', 'keychain', 'key holder']),
       supplier('High Caliber Line',
                category('Key Chains'),
     ...
     ['Wallets',
      [match('name', 'wallet'),
       supplier('Norwood',
                match('name', 'budget traveler')), # Just 15098
       supplier('Leeds',
                all(category('Travel Gifts', 'Clocks & Wallets'),
  ...
  [supplier('Leeds',
   ...
   supplier('High Caliber Line',
     ...
     ['Camping',
      [match('name', 'tent') ]],
     ['Outdoor Seating',
      [match('name', ['stadium seat', 'stadium cushion', 'stadium kushion', 'outdoor lounger', 'chair', 'recliner', 'seat cushion']),
 ...
 ['Tools',
  [supplier('Leeds',
   ...
   supplier('Norwood',
     ...
     ['Screwdrivers',
      [match(%w(name description), 'screwdriver'),
       supplier('Lanco',
  ...
  [ supplier('High Caliber Line',
     ...
     ['Highlighters',
      [match('name', 'highlighter', 1),
       ...
       supplier('High Caliber Line',
                category('Writing Instruments', 'Highlighters,Markers and Accessories') ),
       supplier('Lanco',
