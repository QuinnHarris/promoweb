...
[
  ...
  [
     ...
     ['Awards & Plaques',
      [match('name', 'trophy'),
       ...
       sup('Lanco', cat('Awards & Trophies', 'Awards') ),
      ],[ 
        ['Bases',
          [sup('Norwood', cat('AWARD', 'BASES') ), ]],
         ['Plaques',
          [match('name', 'plaque', 1),
           sup('Norwood', cat('AWARD', 'PLAQUES') ),
           sup('Lanco', cat('Awards & Trophies', 'Plaques') ), ]],
         ['Crystal Awards',
     ...
     ['Trophies',
      [sup('Norwood', sup('AWARD', 'TROPHIES') ),
       sup('Lanco', cat('Awards & Trophies', 'Trophies') ),]],
     ['Vases',
      [sup('Norwood', cat('AWARD', 'VASE') ),
       sup('The Magnet Group', cat('Crystal', 'Vases') ),
       sup('Prime Line', cat('Flexi-Vase') ),
      ] ],
    ] ],
 ['Calendars',
  [
     ...
     ['NUVO by Triumph Calendars',
      [sup('Norwood', cat('CALENDAR', 'NUVO') ) ]],
     ['Planners',
  ...
  [sup('Norwood', cat('AUTO', 'AUTO'))
     ...
     ['Auto Accessories',
      [match('name', ['roadside', 'auto visor']),
       ...
       sup('Bullet Line', cat('Travel & Auto', 'Automotive Accessories') ),
     ...
     ['Auto Safety     ',
      [sup('Leeds', cat('Safety & Auto', 'Auto Safety') ),
       ...
       sup('Starline', cat('Flashlights', 'Roadside Safety') ),
      ] ],
     ['Ice Scraper',
      [match('name', 'ice scraper'),
       sup('Lanco', cat('Tools & Home Technology', 'Ice Scraper') ) ]],
    ]],
 ['Bags',
   ...
   sup('Bullet Line', cat('Bags', 'Business Cases') ),
     ...
     ['Backpacks',
      [match('name', %w(Backpack Daypack Sports\ Pack)),
       ...
       sup('Lanco', cat('Bags & Packs', 'Backpacks')),
       ...
       sup('Starline', cat('Bags', 'Backpacks'), cat('Bags', 'Urban Peak') )
      ],[
         ['Cooler Backpacks',
          [match('name', 'cooler', 1)]],
         ['Computer Backpacks',
          ...
          [match('name', %w(drawstring cinch), 1),
           ...
           sup('Gemline',
               ...
               all(cat('Backpacks', 'Sports'),
                   match('name', 'cinch') ) ),
           sup('Bullet Line', cat('Bags', 'Cinches & Backpacks')),
           sup('Starline', cat('Bags', 'Cinchpaks') )
          ]],
         ['Hydration Backpacks',
          [match('name', 'hydrat', 1),
           match('name', 'hydration pack'),
           sup('Starline', cat('Lifestyles and Golf', 'Hydration Packs') ),]],
         ['Kid Friendly Backpacks',
          [sup('Gemline', cat('Kid-friendly', 'Backpacks') ) ] ],
         ['Sling Backpacks',
          [match('description', 'sling', 1),
           sup('Leeds', cat('Backpacks', 'Cinches & Slings')),
           sup('Gemline',
               all(cat('Backpacks', 'Sports'),
                   match('name', 'sling') ) ) ]],
         ['Tote Backpacks',
         ...
         ['Wheeled Backpacks',
          [match('name', %w(wheel roll), 1),
           ...
           sup('Leeds', cat('Backpacks', 'Wheeled Backpacks') ), ]],
         ['Womens Backpacks',
     ...
     ['Duffel Bags',
      [match('name', ['duffel', 'duffle']),
       ...
       sup('Lanco',
           cat('Bags & Packs', 'Duffles'),
           cat('Bags & Packs', 'Sport and Duffle Bags') ),
       ...
       sup('Starline', cat('Bags', 'Computer Bags') )
         ...
         ['Laptop Sleeves',
          [match('name', 'laptop sleeve'),
           sup('Prime Line', cat('BUILT', 'Laptop Case/Sleeves'))
          ]],
        ] ],
     ['Wheeled Bags',
      [match('name', 'wheel', 1),
     ...
     ['Tote Bags',
      [match('name', 'tote'),
       ...
       sup('Lanco',
           cat('Bags & Packs', 'Polyester Totes'),
           cat('Bags & Packs', 'Custom Totes'),
           ),
      ],[
         ['Business & Meeting Totes',
          [match(%w(name description), %w(business meeting computer laptop), 1),
           ...
           sup('Leeds', cat('Totes', 'Business')),] ],
         ['Cotton Canvas Totes',
          [match(%w(name description material), %w(cotton canvas), 1),
           sup('Leeds', cat('Totes', 'Cotton') ),
           sup('Gemline', cat('Totes', 'Cotton Bags') ),
           sup('Lanco', cat('Bags & Packs', 'Canvas Totes') ),]],
         ['Jute Totes',
         ...
         ['Non-woven Polypropylene Totes',
          [match('material', %w(poly non-woven non\ woven), 1),
           ...
           sup('Lanco', cat('Bags & Packs', 'Non Woven & Nylon Totes') ),]],
         ['Shopper Totes',
     ...
     ['Pouches',
      [match('name', 'pouch'),
       sup('Lanco', cat('Bags & Packs', 'Vinyl Bags & Pouches'))] ],
     ['Amenity Cases',
      [match('name', 'toiletr'),
       sup('Gemline', cat('Travel', 'Amenity cases') ),
       sup('Bullet Line',
           all(cat('Travel & Auto', 'Travel Accessories'),
 ...
 ['Candles, Bath & Body',
  [
     ...
     ['Bath & Body Kits',
      [sup('Lanco', cat('Bath & Body', 'Bath & Body Kits') ) ]],
     ['Bath & Body Care',
      [sup('Lanco', cat('Bath & Body', 'Bath & Body Care') ) ]],
     ['Candles',
      [match('name', 'candle'),
       sup('Lanco',
           cat('Bath & Body', 'Candles'),
           cat('Bath & Body', 'Candles in Tins & Glass Jars'),
           cat('Holiday & Gifts', 'Candles in Tins & Glass Jars') ) ]],
     ['Bath & Body Kits',
      [match('name', 'spa kit'),
       sup('Lanco', cat('Bath & Body', 'Bath & Body Kits') ) ]],
     ['Massagers',
      [match('name', 'massager') ]],
     ['Bath & Body Lotions',
      [sup('Lanco', cat('Bath & Body', 'Bath & Body Lotions') ) ]],
    ] ],
 ...
 ['Brands',
  [sup('Gemline', duplicate(['Brands'], 'supplier_categories'))
     ...
     ['TaylorMade®/adidas®',
      [sup('Norwood', cat('GOLF', 'TAYLOR')) ]],
     ['Callaway®',
      [match('name', 'callaway'),
       sup('Norwood', cat('GOLF', 'CALLAWAY')),
       sup('Sweda', cat('Brands', 'Callaway') )
      ]],
     ['Wilson®',
     ...
     ['Aladdin®', [match('name', 'aladdin')]],
     ['Cool Gear®', [match('name', 'cool gear')]],
     ['Cutter & Buck®', [match('name', 'Cutter & Bluck')]],
     ['Hampton', [match('name', 'hampton')]],
     ['Hunt Valley™', [match('name', 'hunt valley')]],
     ['Wenger®', [match('name', 'wenger')]],
     ['Zippo®', [match('name', 'zippo')]],
     ['contigo®',
      [sup('ETS Express Inc', cat('contigo')) ]],
     ['h2go®',
      [sup('ETS Express Inc', cat('h2go bottles')) ]],
     ['Oakley',
      [sup('Sweda', cat('Brands', 'Oakley') ) ]],
     ['Xoopar',
      [sup('Sweda', cat('Brands', 'Xoopar') ) ]],
     ['blueLounge',
   ...
   sup('Crown Products', cat('Techno Trends') ),
     ...
     ['CD Products',
      [match('name', ['CD case', 'DVD case']),
       sup('Lanco', cat('Office Essentials', 'CD Products') ),]],
     ['Computer Accessory Kits',
      [match('name', 'computer accessories')]],
     ['Computer Brush',
      [match('name', 'computer brush'),
       sup('Lanco', cat('Technology', 'Computer Brush') ) ]],
     ['Cables & Cords',
     ...
     ['Computer Mouse Pads',
      [match('name', ['mousepad', 'mouse pad']), 
       sup('Lanco', cat('Technology', 'Mouse Pads') ),
       sup('Bic Graphics',
     ...
     ['Microfiber Cloths',
      [match('name', 'microfiber cloth'),
       sup('Lanco', cat('Technology', 'Microfibers') ),
      ]],
     ['MP3 Players',
     ...
     ['Camera & Phone Holders',
      [all(match('name', 'case'),
       ...
       sup('Logomark', cat('Mobile Phone Holders') ), ]],
     ['USB Hubs',
      [match('name', 'hub', 1),
     ...
     ['USB Flash Drives',
      [match('name', %w(flash memory mb gb), 1),
       ...
       sup('Leeds', cat('Memory', 'Usb Memory (Memory)') ),
       sup('Lanco', cat('Technology', 'USB Flash Drives') ),
      ],[
         ['Pen USB Flash Drives',
          [match('name', 'pen', 1),
           sup('LogoIncluded', cat('Pen Drive') ),
           sup('Lanco', cat('Writing Instruments', 'USB Flash Drives') ),
          ]],
         ['Recycled Flash Drives',
          [match(%w(name description), 'recycle', 1) ]],
        ] +
      ['1G', '2G', '4G', '8G', '16G', '32G', '64G'].collect do |name|
        ["#{name}B Flash Drives",
         [match('name', name, 1),
          sup('LogoIncluded',
              match('memory', name) ) ]]
     ...
     ['Digital Photo Frames',
      [match('name', 'digital frame'),
       sup('Leeds', all(match('name', 'digital'), cat('Desktop', 'Photo Frames') ) ),
       sup('LogoIncluded', cat('Digital Photo Frame') ),
       sup('Sweda', cat('Tech', 'Digital Picture Frames') )
      ]],
    ] ],
   ...
   sup('Crown Products', cat('Office Accessories') ),
     ...
     ['Calculators',
      [match('name', 'calculator'),
       ...
       sup('Lanco', cat('Office Essentials', 'Calculators') ),
       sup('Hit Promotional Products',
           match('name', 'calc') ),
       ...
       sup('Sweda',
           ...
           cat('Home + Office', 'Calculators') ),
       ] ],
     ['Clocks',
      [match('name', 'clock'),
       sup('Lanco', cat('Office Essentials', 'Clocks') ),
     ...
     ['Picture Frames',
      [match('name', ['photo frame', 'picture frame']),
       ...
       sup('Leeds', cat('Desktop', 'Photo Frames') ),
       sup('Prime Line',
           match('name', 'frame')),
       sup('Logomark',
           cat('Photo Frames'),
     ...
     ['Letter Openers',
      [match('name', ['letter opener', 'slitter']),
       match('name', 'opener', 1),
       sup('Lanco', cat('Office Essentials', 'Letter Opener') ),
     ...
     ['Speakers',
      [match('name', 'speaker')] ],
     ['Headphones & Earbuds',
      [match('name', %w(headphones head\ phones earbuds ear\ buds earphone ear\ plugs ear\ phones) + [/bluetooth.+headset/i]),
       all(match('name', 'headset'), match('name', 'headphones') ),
       sup('Leeds',
           all(cat('Mobile Tech', 'Audio'),
               match('name', %w(head ear)) ) ),
       sup('LogoIncluded', cat('Bluetooth Headset') ),
       sup('Bullet Line', cat('Technology', 'Audio') )
      ] ],
     ['Mobile Device Stands & Organizers',
      [sup('Leeds', cat('Desktop', 'Mobile Tech Stands & Organization') ),
       sup('Prime Line', cat('Mobile Device Holders') ), ]],
     ['Desktop Organizers',
     ...
     ['Note Holders',
      [match('name', ['note holder', 'memo holder', 'memo stack', 'Post-it holder','note dispenser', 'sticky note', 'sticky flag', 'message pad']), #, 1),
       sup('Lanco',
           cat('Office Essentials', 'Memo Holder'),
           cat('Office Essentials', 'Memo Dispenser'),
           cat('Office Essentials', 'Sticky Holder')),
       sup('High Caliber Line',
           all(cat('Office'),
               match('name', ' clip') ),
           match('name', 'note holder') ),
       sup('Bullet Line', 
           cat('Desktop', 'Magnets & Memos'),
           cat('Sticky Notes', 'Office Accessories') ),
     ...
     ['Paper Clip Holders',
      [match('name', ['clip dispenser', /paper.+clip.+((dispens)|(holder))/i]),
       ...
       sup('Lanco', cat('Office Essentials', 'Paper Clip Holder') ),
       sup('Prime Line',
           match('name', 'cache') )]],
     ['Paperweights',
     ...
     ['Tape Dispensers',
      [match('name', 'tape dispenser'),
       sup('Lanco', cat('Office Essentials', 'Tape Dispenser') ),
       sup('High Caliber Line',
           all(cat('Office'),
               match('name', 'tape') ) )]],
     ['Magnets',
 ...
 ['Coolers',
  [match('name', ['cooler', 'kooler']),
   sup('Gemline',
       cat('Coolers', 'New') ),
   sup('Lanco', cat('Bags & Packs', 'Lunch Bag & Coolers')),
   sup('Prime Line',
       cat('Bags', 'Coolers'),
       all(cat('Bags'),
   ...
   sup('Starline', cat('Bags', 'Cooler Bags') ),
  ],[
     ['Can Coolers',
      [match('name', ['can', /(\d+|six)[ -]pack/i], 1)] ],
     ['Chair Coolers',
      [match('name', 'chair', 1) ] ],
     ['Event Coolers',
      [sup('Leeds', cat('Coolers', 'Event Coolers') ),
       sup('Bullet Line', cat('Coolers', 'Event Coolers') ),
       sup('Gemline', cat('Coolers', 'Event') ) ]],
     ['Drink Coolers',
      [match('name', 'water bottle', 1),
 ...
 ['Drinkware',
  [#match('name', %w(coffe))
   ...
   sup('Lanco', cat('Drinkware & Coolers', 'Cups') ),
   ...
   sup('ETS Express Inc'),
   sup('Starline', cat('Drinkware', 'Vacuum Water Bottles') ),
  ],[
     ['Acrylic Drinkware',
      [match(%w(name description material), 'acrylic', 1),
     ...
     ['Aluminum Bottles',
      [match(%w(name description material), 'aluminum', 1),
       ...
       sup('Lanco', cat('Drinkware & Coolers', 'Metal Bottles') ),
       sup('ETS Express Inc',
           cat('aluminum') ),
      ]],
     ['Barware',
      [sup('Starline', cat('Drinkware', 'Barware') )] ],
     ['Branded Drinkware',
      [sup('Leeds', cat('Drinkware', 'Branded') ),
      ],[
         ['Aladdin® Drinkware', [match('name', 'aladdin', 1)]],
         ['Cool Gear® Drinkware', [match('name', 'cool gear', 1)]],
         ['Cutter & Buck® Drinkware', [match('name', 'Cutter & Bluck', 1)]],
         ['Hampton Drinkware', [match('name', 'hampton', 1)]],
         ['Hunt Valley™ Drinkware', [match('name', 'hunt valley', 1)]],
         ['Wenger® Drinkware', [match('name', 'wenger', 1)]],
         ['Zippo® Drinkware', [match('name', 'zippo', 1)]],
         ['contigo® Drinkware', [sup('ETS Express Inc', cat('contigo')) ]],
         ['h2go® Drinkware', [sup('ETS Express Inc', cat('h2go bottles')) ]],
        ]],
     ['Stainless Steel Bottles', # Should this be vacuum tumbers?
      [match('name', 'stainless', 1),
       sup('Leeds', cat('Drinkware', 'Stainless Sport Bottles')),
       sup('ETS Express Inc', cat('steel') ),
       sup('Prime Line', cat('Drinkware', 'Stainless/Aluminum') ),
      ]],
     ['Vacuum Tumblers',
      [sup('Sweda', cat('Drinkware', 'Vacuum Bottles') ),
       sup('Starline', cat('Drinkware', 'Vacuum Tumblers'),
           cat('Drinkware', 'Vacuum Insulated Bottles') )
      ] ],
     ['Vacuum Storage Containers',
      [sup('Starline', cat('Drinkware', 'Vacuum Storage Containers') ),
      ] ],
     ['Can & Bottle Holders',
      [match('name', ['can holder', 'bottle holder', 'bottle insulator']), # Was matched on descrption but to broad
       ...
       sup('Lanco', cat('Drinkware & Coolers', 'Can & Bottle Holder') ),
     ...
     ['Coasters', 
      [match('name', 'coaster'),
       sup('Lanco', cat('Drinkware & Coolers', 'Coasters') ),
       sup('Norwood',
     ...
     ['Ceramic',
      [match('name', 'ceramic', 1),
       ...
       sup('Lanco', cat('Drinkware & Coolers', 'Ceramic Mugs') ),
       sup('Hit Promotional Products', cat('Ceramic Mugs') )
      ]],
     ['Drinkware Gift Sets',
      [sup('Leeds', cat('Drinkware', 'Gift Sets') ),
       sup('Lanco',
           cat('Drinkware & Coolers', 'Gift Boxes & Baskets'),
           cat('Drinkware & Coolers', 'Drinkware Gift Boxes & Baskets') ),
      ]],
     ['Insulated Bottles',
     ...
     ['Mugs & Tumblers',
      [match('name', %w(tumbler mug), 1),
       ...
       sup('Lanco', cat('Drinkware & Coolers', 'Travel Mugs & Tumblers') ),
       sup('Norwood', cat('DRINK', 'METAL') ),
       sup('High Caliber Line',
           match('name', 'Mug') ),
       sup('Bullet Line', cat('Drinkware', 'Tumblers & Mugs') ),
       sup('Logomark',
           cat('Mugs'),
           cat('Tumblers') ),
       sup('Sweda',
           cat('Drinkware', 'Travel Mugs'),
           cat('Drinkware', 'Tumblers') ),
       sup('Starline', cat('Drinkware', 'Travel Mugs'),
           cat('Drinkware', 'Travel Tumblers') ),
       sup('Prime Line', cat('Drinkware', 'Tumblers') ),
      ],[
         ['Ceramic Coffee Mugs',
          [match('name', 'coffee', 1),
           sup('Lanco', cat('Drinkware & Coolers', 'Mugs') ),
     ...
     ['Sport Bottles',
      [match('name', %w(bottle chill poly polly sports), 1),
       ...
       sup('Lanco',
           cat('Drinkware & Coolers', 'Polycarbonate Bottles'),
           cat('Drinkware & Coolers', 'Sports Bottles')),
 ...
 ['Food Gifts',
  [sup('Lanco',
       cat('Food Gifts', 'Gum, Mint & Candevelopes'),
       cat('Food Gifts', 'Tea, Java, Creamelopes'),
       cat('Holiday & Gifts', 'Gourmet Food Fills') ),
  ],[
     ['Lollipop',
     ...
     ['Cookies',
      [sup('Lanco', cat('Food Gifts', 'Cookies') ) ]],

     ['Gourmet Food Gifts',
      [sup('Lanco',
           cat('Food Gifts', 'Gourmet Food Gifts'),
           cat('Food Gifts', 'Gourmet Food Gifts & Tins'),
           cat('Holiday & Gifts', 'Gourmet Food Gifts'),
           cat('Holiday & Gifts', 'Gourmet Food Gifts & Tins'),
           cat('Holiday & Gifts', 'Gourmet Food in Tins'),
           cat('Holiday & Gifts', 'Gourmet Food in Jars'),
           ) ]],
     
     ['Gourmet Food Gift Baskets, Boxes & Trays',
      [sup('Lanco',
           cat('Holiday & Gifts', 'Gourmet Food Gift Basket'),
           cat('Holiday & Gifts', 'Gourmet Food in Tubs'),
           cat('Holiday & Gifts', 'Food & Drinkware Gift Tray'),
           cat('Holiday & Gifts', 'Food & Drinkware Gift Box'),
           cat('Holiday & Gifts', 'Travel Mugs & Tumblers'),
           cat('Holiday & Gifts', 'Sports Bottles'),
           cat('Holiday & Gifts', 'Mugs') )
     ]],
     ...
     ['Chocolate',
      [],[
          ['Chocolate Truffles',
           [sup('Lanco',
                cat('Food Gifts', 'Chocolate Truffles'),
                cat('Holiday & Gifts', 'Chocolate Truffles') ) ]],
          ['Chocolate Bars',
           [sup('Lanco', cat('Food Gifts', 'Chocolate Bars') ) ]],
          ['Custom Molded Chocolate',
           [sup('Lanco',
                cat('Holiday & Gifts', 'Custom Molded Chocolate'),
                cat('Holiday & Gifts', 'Custom Molded & Novelty Chocolate'),
                cat('Food Gifts', 'Custom Molded Chocolate') ) ]],
          ['Novelty Chocolate',
           [sup('Lanco', cat('Holiday & Gifts', 'Novelty Chocolate') ) ]],

          ['Wrapped Chocolate Pieces',
           [sup('Lanco',
                cat('Food Gifts', 'Chocolate Foil Wrapped Pieces'),
                cat('Holiday & Gifts', 'Wrapped Chocolate Items'),
                cat('Food Gifts', 'Wrapped Chocolate Items') ), ]],
      
          ['Chocolate Gift Boxes & Sets',
           [sup('Lanco',
                cat('Food Gifts', 'Chocolate in Gift Boxes'),
                cat('Holiday & Gifts', 'Chocolate in Gift Boxes'),
                cat('Food Gifts', 'Chocolate Squares in Gift Sets'),
                cat('Holiday & Gifts', 'Chocolate Squares in Gift Sets'),
                cat('Holiday & Gifts', 'Chocolate Gifts')) ]],
         ]],
     ...
     ['Mints',
      [match('name', 'mint'),
       exclude(match('name', %w(lip balm)) ),
       sup('Lanco', cat('Food Gifts', 'Mints') ),
      sup('High Caliber Line',
          cat('Mints') )]],
     ['Coffee, Hot Chocolate, Ice Tea',
      [sup('Lanco',
           cat('Food Gifts', 'Coffee, Hot Chocolate, Ice Tea'),
           cat('Holiday & Gifts', 'Coffee & Tea'),
           cat('Holiday & Gifts', 'Coffee, Hot Chocolate, Ice Tea') ) ]],
     ['Novelty Chocolate',
     ...
     ['Bottled Water',
      [match('name', 'bottled water'),
       sup('Lanco', cat('Food Gifts', 'Bottled Water & Totes') ) ]],
     ['Tea Bags',
      [match('name', 'tea bag'),
 ...
 ['Games & Toys',
  [sup('Leeds',
   ...
   sup('Starline', cat('Lifestyles and Golf', 'Games') ),
  ],[
     ['Balls',
      [match('name', /ball$/i),
       exclude(match('name', 'golf')) ] ],
     ['Electronic Games',
      [match('name', 'electr', 1),
     ...
     ['Stress Reliever',
      [match('name', 'stress', 1),
       ...
       sup('Bullet Line',
           ...
           cat('Stress Relievers', 'Stress Shapes')),
 ...
 ['Travel',
  [sup('Gemline', cat('Gifts', 'Travel') ),
   ...
   sup('Crown Products', cat('Travel') )
     ...
     ['Travel Accessories',
      [sup('Leeds',
           cat('Travel Gifts', 'Travel Sets & Accessories'),
           exclude(match('name', 'charge'))),
       sup('Bullet Line', cat('Travel & Auto', 'Travel Accessories') ),
     ...
     ['Travel Sets',
      sup('Leeds', cat('Travel Gifts', 'Travel Sets & Accessories') ) ],
     ['Utility Kits',
  ...
  [
   ...
   sup('Hit Promotional Products', cat('Housewares') ),
     ...
     ['Boxes & Waterproof Containers',
      sup('Lanco', cat('Bags & Packs', 'Boxes / Waterproof Containers'))],
     ['BBQ & Picnic',
     ...
     ['Kitchen',
      [match(%w(name description), 'kitchen'),
       ...
       sup('Starline', cat('HomeStyles', 'Kitchen Accessories') ),
      ],[
         ['Aprons',
          [match('name', 'apron'),
   ...
   sup('Leeds', cat('Personal Wellness', 'Exercise & Fitness Accessories') )
     ...
     ['Stain Removers',
      [match('name', 'stain remove'),
       sup('Lanco', cat('Health & Travel', 'Stain Removers'))
      ] ],
     ['Pedometers',
      [match('name', ['pedometer', 'step-meter', 'step meter']),
       ...
       sup('Lanco', cat('Health & Travel', 'Pedometer') ),
       sup('Bullet Line', cat('Fitness & Recreation', 'Pedometers') ),
       sup('Sweda', cat('Sports + Health', 'Pedometers') ),
      ] ],
     ['Fitness Sets',
      [sup('Bullet Line', cat('Fitness & Recreation', 'Sports & Fitness Sets') ),
       all(match('name', %w(set kit), 1),
           match('name', %w(exercise fitness)) ) ]],
     ['Dental Products',
      [match('name', %w(floss toothbrush tooth\ brush toothpick))]],
     ['Pill Cases',
      [match(%w(name description), ['pill hold', 'pill case', 'pill box', 'pillbox', 'pill tube', 'pill caddy']),
       sup('Lanco', cat('Health & Travel', 'Pill Cases') ),
       sup('Norwood', cat('HEALTH', 'PILLBOX') )]],
     ['Pill Cutters',
      [match('name', 'pill cut'),
       sup('Lanco', cat('Health & Travel', 'Pill Cutters') )]],
     ['Bug Repellant',
      [match('name', ['bug zapper', 'bug repellant']),
      ] ],
     ['Shoe Accessories',
      [match('name', %w(shoe callus)),
       sup('Lanco', cat('Health & Travel', 'Shoe Items') ) ]],
     ['Soap',
      [match('name', 'soap') ] ],
     ...
     ['Fans',
      [match('name', ['mini fan', 'hand fan', 'personal fan']),
       sup('Lanco', cat('Health & Travel', 'Fans') ),
       sup('High Caliber Line',
           all(cat('Toys & Games'),
               match('name', 'fan') ) ),
      ]],
     ['Mirrors',
      [match('name', 'mirror'),
       sup('Lanco', cat('Health & Travel', 'Mirrors') ) ]],
     ['Lint Brushes',
      [match(%w(name description), ['lint brush', 'lint roller']),
       sup('Lanco', cat('Health & Travel', 'Lint Brushes') ) ]],
     ['Brush & Combs',
      [sup('Lanco', cat('Health & Travel', 'Brush & Combs') ) ]],
     ['Sewing Kits',
      [match('name', ['sewing kit', 'mending']),
       sup('Lanco', cat('Health & Travel', 'Sewing Kits') ) ]],
     ['Dental Products',
      [sup('Lanco', cat('Health & Travel', 'Dental Products') ) ]],
     ['Sun Kits',
      [sup('Lanco', cat('Golf, Outdoors, Sports', 'Sun Kits') ) ]],
     ['Lip Balm',
      [match('name', %w(lipbalm lip\ balm)),
       sup('Lanco',
           cat('Golf, Outdoors, Sports', 'Lipbalm'),
           cat('Bath & Body', 'Lipbalm') ),
       sup('High Caliber Line', cat('Lip Balm') )
      ]],
     ['Outdoor Kits',
      [sup('Lanco', cat('Golf, Outdoors, Sports', 'Outdoor Kits') ) ]],
     ['Sunblock',
      [match('name', %w(sunscreen sun\ screen sunblock sun\ block)),
       sup('Lanco',
           cat('Golf, Outdoors, Sports', 'Sunscreen'),
           cat('Bath & Body', 'Sunscreen') ),
  ...
  [
     ...
     ['Umbrellas & Rainwear',
      [match('name', 'umbrella'),
       ...
       sup('Lanco', cat('Golf, Outdoors, Sports', 'Umbrellas') ),
       sup('Bullet Line', cat('Fitness & Recreation', 'Umbrellas') ),
       sup('Hit Promotional Products', cat('Umbrellas') ),
       sup('Starline', cat('Lifestyles and Golf', 'Umbrellas') ),
      ],[
         ['London Fog',
     ...
     ['Phone Holders',
      [match('name', ['phone holder', 'phone stand']),
       sup('Lanco',
           cat('Bags & Packs', 'Phone Holders'),
           cat('Technology', 'Phone Holders') ),
     ...
     ['Sun Glasses',
      [match('name', 'sunglasses'),
       ...
       sup('Starline', cat('Safety', 'Outdoor Sport Glasses') )
      ] ],
     ['Safety Glasses',
      [sup('Starline',
           cat('Safety', 'Safety Eyewear'),
           cat('Safety', 'Bollé Safety Eyewear') )
       ] ],
     ['Head Protection',
      [sup('Starline', cat('Safety', 'Head Protection') )
      ] ],
     ['Work Gloves',
      [sup('Starline', cat('Safety', 'Hand Protection') )
      ] ],
     ['Badge Holders',
     ...
     ['Lanyards',
      [match('name', 'lanyard'),
       sup('Lanco', cat('Office Essentials', 'Badge Holder Accessories') ),
       sup('High Caliber Line',
           cat('Lanyards'),
     ...
     ['Dog Tags',
      [sup('Lanco', cat('Office Essentials', 'Dog Tags') )]],
     ['Carabiners',
      [match('name', 'carabiner'),
       sup('Lanco', cat('Tools & Home Technology', 'Carabiner') ),
     ...
     ['Key Chains',
      [match(%w(name description), ['key chain', 'keychain', 'key holder', 'key tag', 'key ring']),
       ...
       sup('Lanco',
           cat('Tools & Home Technology', 'Keychains'),
           cat('Bath & Body', 'Keychains') ),
       ...
       sup('Sweda',
           cat('Outdoors', 'Key Lights + Key Tags'),
           cat('Key Tags'),
           cat('Keychains') ),
       sup('The Magnet Group',
           cat('Innovations', 'Keytags'),
           cat('Innovations', 'Keychains') ),
       sup('Starline', cat('Business Essentials', 'Key Fobs') ),
      ],[
     ...
     ['Wallets',
      [match('name', %w(wallet checkbook)),
       ...
       sup('Leeds',
           cat('Travel Gifts', 'Card Holders & Wallets') ),
      ]],
     ['Money Clips',
     ...
     ['Watches',
      [match('name', 'watch'),
       ...
       sup('Logomark',
           cat('Classic Watches'),
           cat('Fashion Watches') ),
       sup('Sweda', cat('Watches') ),
      ],[
         ['Analog Watches',
          [match(%w(name description), 'analog', 1),
           sup('Sweda', cat('Time', 'Watches - Analog') ),
           sup('Logomark', cat('Bracelet Watches') ),
          ] ],
         ['Digital Watches',
          [match(%w(name description), 'digital', 1),
            sup('Sweda', cat('Time', 'Watches - Digital') ),
          ] ],
         ['Sport Watches',
          [match('name', 'sport', 1),
           sup('Logomark', cat('Sport Watches') ),
           sup('Sweda', cat('Time', 'Analog Sport') ),
          ] ],
        ] ],
   ...
   sup('Bullet Line', cat('Fitness & Recreation', 'Summer & Outdoor Items')),
     ...
     ['Binoculars & Telescopes',
      [match('name', %w(binocular telescope monocular)),
       ...
       sup('Starline', cat('Lifestyles and Golf', 'Binoculars') ),
      ] ],
     ...
     ['Golf',
      [match('name', 'golf'),
       ...
       sup('Norwood', cat('GOLF', 'GOLFACC') ),
       sup('Crown Products', cat('Golf') ),
       sup('Logomark', cat('Golf Gifts' ) ),
       sup('Starline', cat('Lifestyles and Golf', 'Golf') ),
      ],[
         ['Golf Balls',
          [match('name', 'balls', 1),
           sup('Lanco', cat('Golf, Outdoors, Sports', 'Golf Balls') ),
           sup('Norwood', cat('GOLF', 'GOLFBALL') ) ] ],
        ['Golf Kits',
          [match('name', 'kit', 1),
           match('name', 'putter'),
           sup('Lanco', cat('Golf, Outdoors, Sports', 'Golf Kits') ),
           sup('Norwood', cat('GOLF', 'EVENT') )]],
         ['Golf Towels',
          [match('name', 'towel', 1),
           sup('Lanco', cat('Golf, Outdoors, Sports', 'Golf Towels') )]],
         ['Tees, Ball Markers & Divot Tools',
          [match('name', ['tees', 'ball marker'], 1),
           match('name', 'divot'),
           sup('Lanco', cat('Golf, Outdoors, Sports', 'Tees, Markers & Divot Tools') ),
     ...
     ['Outdoor Seating',
      [match('name', ['chair', 'recliner', 'lounger']),
       ...
       sup('Leeds', cat('Outdoor Living', 'Event Seating') ),
       sup('Lanco',
           cat('Golf, Outdoors, Sports', 'Cushions'),
           cat('Golf, Outdoors, Sports', 'Seats') ) ] ],
     ['Excursion',
   ...
   sup('The Magnet Group', cat('Bag Factory', 'Stationery & Writing') )
     ...
     ['Jotters',
      [match('name', ['notepad', 'notebook']),
       ...
       sup('Bullet Line', cat('Stationery', 'Jotters') ),
       sup('Norwood', cat('MEETING', 'JOTTERS') ),
       sup('Lanco',
           cat('Office Essentials', 'Notebooks'),
           cat('Office Essentials', 'Memo Pads')),
       sup('High Caliber Line',
           match('name', 'notebook') ),
       sup('Bic Graphics',
     ...
     ['Journals',
      [match('name', 'journal'),
       ...
       sup('Lanco', cat('Office Essentials', 'Journal Books') ),
     ...
     ['Padfolios & Writing Pads',
      [match('name', 'padfolio'),
       sup('Leeds',
           cat('Stationery', 'Padfolios & Writing Pads'),
           cat('Mobile Tech', 'Cases') ),
       sup('Gemline',
       ...
       sup('Logomark', 
           ...
           cat('Zip Padfolios') ),
       sup('Prime Line', cat('Office', 'Padfolios') ),
       sup('Sweda', cat('Stationery', 'Portfolios') ),
       sup('Starline', cat('Business Essentials', 'Portfolios/Padfolios') ),
      ],[
         ['Jr. Padfolios',
          [match('name', 'jr', 1),
         ...
         ['Leather Padfolios',
          [sup('Gemline', cat('Padfolios/e-Padfolios', 'Leather') ),
           sup('Prime Line', cat('Lifestyle', 'Leather Padfolios') ),
          ]],
         ['Recycled Pads',
          [match(%w(name description), 'recycle', 1) ]],
        ] ],
 ...
 ['Tools',
  [sup('Leeds', cat('Tools & Lighters', 'Tools') ),
   ...
   sup('Sweda', cat('Tools'), cat('Outdoors', 'Tools') ),
   sup('The Magnet Group', cat('Innovations', 'Tools') )
  ],[
     dup('Tools & Home Technology', 'Ice Scraper'),
     ['Bag Clips',
      [match('name', 'bag clip'),
       sup('Lanco', cat('Tools & Home Technology', 'Bag Clips') ),
       sup('Norwood',
     ...
     ['Bottle Openers',
      [match('name', 'bottle opener'),
       ...
       sup('Lanco', cat('Tools & Home Technology', 'Bottle Opener') ),
       sup('Bullet Line', cat('Key Tags & Badge Holders', 'Bottle Openers') ),
     ...
     ['Flashlights',
      [match('name', /(^|\s+)LED(\s+|$)/),
       ...
       sup('Sweda',
           cat('Flashlights'),
           cat('Outdoors', 'Flashlights - Metal'),
           cat('Outdoors', 'Flashlights - Plastic') ),
       sup('The Magnet Group', cat('Innovations', 'Flashlights') ),
       sup('Starline', cat('Flashlights', 'Search Lights') ),
      ],[
         ...
         ['Dynamo Flashlights',
          [sup('Leeds', cat('Flashlights', 'Dynamo') ),
           sup('Starline', cat('Flashlights', 'Emergency Dynamo/Solar') ),
           sup('Bullet Line', cat('Lighting', 'Wind-Up Flashlights') ),
          ] ],
         ['LED Flashlights',
     ...
     ['Screwdrivers',
      [match(%w(name description), %w(screwdriver screw\ driver)),
       sup('Lanco',
           all(cat('Tools & Home Technology', 'Screwdriver & Tool Set'),
               match('name', 'screwdriver') ) ) ]],
     ['Tape Measures',
      [match(%w(name description), 'tape measure'),
       sup('Lanco', cat('Tools & Home Technology', 'Tape Measure') ),
    ...
    sup('Sweda', cat('Writing Instruments') ),
     ...
     ['Highlighters',
      [match('name', 'highlighter', 1),
       ...
       sup('Lanco', cat('Writing Instruments', 'Highlighters') ),
       sup('Prime Line',
       ...
       sup('Norwood',
           all(match('name', ['highlighter', 'combo writer']),
               cat('WRITE', 'PENCIL') ) ),
       sup('Bullet Line', cat('Pens', 'Highlighters') ),
       sup('Bic Graphics',
     ...
     ['Pencils',
      [match('name', 'pencil'),
       ...
       sup('Lanco', cat('Writing Instruments', 'Pencils') ),
      ]],
     ['Pens',
      [match('name', /pens?($|\s)/i, 1),
       sup('Gemline', cat('Writing Instruments', 'Lamy') ),
       ...
       sup('Lanco',
           ...
           cat('Writing Instruments', 'Click & Twist Pens'),
           cat('Writing Instruments', 'Grip Pens'),
           cat('Writing Instruments', 'Dome Pens'),
           cat('Writing Instruments', 'Wrapped Pens'),
           ),
       sup('Prime Line',
       ...
       sup('The Magnet Group', cat('Innovations', 'Pens') ),
         ...
         # Materials
         ['Metal Pens',
          [sup('Bullet Line', cat('Pens', 'Metal Pens') ),
           sup('Leeds',
               cat('Pens-Metal', 'Ballpoint'),
               cat('Pens-Metal', 'Branded'),
               cat('Pens-Metal', 'Metal Stylus Pens'),
               cat('Pens-Metal', 'Roller Ball') ),
           sup('Prime Line', cat('Writing Instruments', 'Metal Pens') ),
           sup('Lanco', cat('Writing Instruments', 'Metal Pens') ),
           sup('Sweda', cat('Writing Instruments', 'Metal') ),

          ], [
              ['Aluminum Pens',
               [match('material', ['Aluminum', 'anodized al'], 2)
               ] ],
              ['Brass Pens',
              ...
              ['Wood Pens',
               [match('material', %w(wood bamboo), 2) ]],
             ] ],
         ['Plastic Pens',
          [sup('Prime Line', cat('Writing Instruments', 'Plastic Pens') ),
           sup('Bullet Line', cat('Pens', 'Plastic Pens') ),
           sup('Sweda', cat('Writing Instruments', 'Plastic') ),
          ]],
         ['Eco Friendly Pens',
          [match(%w(name description), 'recycle', 1),
         ...
         ['Two-Piece Stic Pens',
          [match('name', 'stick pen'),
           ...
           sup('Lanco', cat('Writing Instruments', 'Stick Pens') ),
          ]],
         ...
         ['Ballpoint Pens',
          [match(%w(name description), 'ballpoint', 1),
         ...
         ['Gel Pens',
          [match('name', 'gel', 1),
           ...
           sup('Bullet Line', cat('Pens', 'Gel Pens') ),
           sup('Bic Graphics',
         ...
         ['Light Up Pens',
          [match('name', /(^|\s)light/, 1),
           sup('Bullet Line', cat('Pens', 'Light-up Pens') ),
           sup('Logomark', cat('Light Pens') ),
           sup('Sweda', cat('Writing Instruments', 'Light-Up & Laser') ),
           sup('Lanco', cat('Writing Instruments', 'Light Up Pens') ),
          ]],
         ['Magnetic Pens',
          [match('name', 'magnet', 1),
         ...
         ['Pens with Stylus',
          [match(%w(name description), 'stylus', 1),
           ...
           sup('Prime Line', cat('Writing Instruments', 'Stylus Pens') ),
           sup('Leeds',
               cat('Pens-Metal', 'Metal Stylus Pens'),
               cat('Pens-Plastic', 'Plastic Stylus Pens') ),
           sup('Lanco', cat('Writing Instruments', 'Stylus Pens') ),
           sup('Bullet Line', cat('Pens', 'Stylus Pens') ),
           sup('Sweda', cat('Writing Instruments', 'Stylus')),
          ] ],
         ['Multi Function Pens',
         ...
         ['Specialty Pens',
          [sup('Lanco', cat('Writing Instruments', 'Specialty Pens') ),
           sup('Prime Line', cat('Writing Instruments', 'Novelty Pens') )]],
         ...
         ['Pen Gift Boxes',
          [match('name', ['gift box', 'pen box'], 1),
           sup('Bullet Line', cat('Pens', 'Gift Boxes for Pens') ) ] ],\
         ['Pen Sets',
 ...
 ['Other',
  [
     ...
     ['Ribbons',
      sup('Lanco', 
          cat('Office Essentials', 'Custom Imprinted Ribbons'),
          cat('Office Essentials', 'Ribbons') ) ],
     ['Blankets',
      [match('name', 'blanket'),
       ...
       sup('Starline', cat('Lifestyles and Golf', 'Blankets') ),
         ...
         ['Home Blankets',
          [match(%w(name description), 'home', 1),
           sup('Leeds', cat('Blankets', 'Home') ) ]],
         ['Outdoor Blankets',
          [match(%w(name description), %w(outdoor beach), 1),
           sup('Leeds', cat('Blankets', 'Outdoor') ) ]],
         ['Travel Blankets',
          [match(%w(name description), 'travel', 1),
           sup('Leeds', cat('Blankets', 'Travel') ) ]],
        ]],
     ['Whistles',
      [match('name', 'whistle') ]],
     ['Gardening',
      [match('name', 'garden'),
       sup('Starline', cat('Lifestyles and Golf', 'Garden') ),]],
     ['Gift Tins',
      [sup('Logomark', cat('Gift Tins') ) ] ],
     ['Stopwatches & Timers',
      [sup('Sweda',
           cat('Stopwatches & Timers'),
           cat('Sports + Health', 'Stopwatches'),
           cat('Time', 'Timers') ) ] ],
    ] ],
