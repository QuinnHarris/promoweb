   ...
   supplier('Bullet Line',
      ...
      [['Notenest & Note Clips',
       ...
       ['Sticky Note Books',
        [match('name', 'sticky memo', 1),
         ...
         supplier('Bullet Line',
                  category('Sticky Notes', 'Booklets & Notebooks') ),
         supplier('Bic Graphics',
     ...
     ['Staplers',
      [match('name', 'stapler'),
       ...
       supplier('Lanco',
                category('Writing Instruments', 'Stapler') )]],
     ['Staple Removers',
      [match('name', 'staple remover'),
       supplier('Lanco',
                category('Writing Instruments', 'Staple Remover') ) ]],
     ['Tape Dispensers',
 ...
 ['Drinkware',
  [#match('name', %w(coffe))
   ...
   supplier('Lanco',
     ...
     ['Specialty Drinkware',
      [supplier('Bullet Line',
                category('Drinkware', 'Specialty Drinkware'))
      ]],
     ...
     ['Stress Reliever',
      [match('name', 'stress', 1),
       ...
       supplier('Lanco',
                ...
                category('Tradeshow', 'Stress Balls & Shapes')),
       supplier('Norwood',
                category('HEALTH', 'STRESS') ),
       supplier('Bullet Line',
                category('Stress Relievers', 'Stress Relievers') ),
   ...
   match('name', 'door knob'),
     ...
     ['Kitchen',
      [match(%w(name description), 'kitchen'),
       match('name', ['measuring cup', 'measuring spoon', 'pizza cutter', 'spatula', 'basting', 'dishwasher', 'silicone glove', 'cream scoop']),
       supplier('Norwood',
     ...
     ['Key Chains',
      [match(%w(name description), ['key chain', 'keychain', 'key holder', 'key tag']),
       ...
       supplier('Lanco',
                ...
                category('Tools / Knives', 'Keychains') ),
       supplier('Norwood',
       ...
       supplier('Bullet Line',
         ...
         ['Bottle Opener Key Chains',
          [match('name', 'opener', 1),
           supplier('Bullet Line',
                    category('Key Tags & Badge Holders', 'Bottle Openers') ) ]],
  ...
  [ supplier('High Caliber Line',
    ...
    supplier('Norwood',
     ...
     ['Markers',
      [match('name', 'marker', 1),
       supplier('Bic Graphics',
                category('Writing Instruments', 'Marker'),
     ...
     ['Pens',
      [match('name', /pen($|\s)/, 1),
       ...
       supplier('Lanco',
                ...
                category('Writing Instruments', 'USA Made Pens') ),
       supplier('Prime Line',
       ...
       supplier('Bullet Line',
         ...
         ['Gel Pens',
          [match('name', 'gel', 1),
           ...
           supplier('Bic Graphics',
                    category('Writing Instruments', 'Gel Pen'),
                    match('supplier_num', 'GEL') ) ] ],
         ['Metal Pens',
          [supplier('Bullet Line',
                    category('Writing Instruments', 'Metal Pens'),
                    category('Writing Instruments', 'Metal Pen') )
          ], [
              ['Aluminum Pens',
         ...
         ['Twist Pens',
          [match('name', 'twist', 1),
           ...
           supplier('Lanco',
                    category('Writing Instruments', 'Twist Pens') )]],
         ['Recycled Pens',
          [match(%w(name description), 'recycle', 1),
           supplier('Gemline',
