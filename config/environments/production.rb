...
Promoweb::Application.configure do
  ...
  config.assets.precompile += %w( orders.css admin.css customer_send.css print.css screen.css prototype.js controls.js dragdrop.js effects.js iehacks.css ie7hacks.css)
