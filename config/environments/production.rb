...
ExceptionNotification::Notifier.exception_recipients = %w(quinn@mountainofpromos.com)
ExceptionNotification::Notifier.sender_address = %("Web Application Error" <error@mountainofpromos.com>)
