class Order < ActiveRecord::Base
  ...
  def payment_authorizes
    ...
    payment_transactions.joins(:method).where("payment_transactions.type = 'PaymentAuthorize' AND payment_transactions.amount > 1000 AND payment_transactions.created_at > (NOW() - (CASE sub_type WHEN 'american_express' THEN '40d' ELSE '14d' END)::interval)")
  end
