...
(function (f) {
    ...
    d.prototype.mouseenterHandler = function (l) {
        if (!l.data._this.sett.testMode) {
            l.data._this.$contentHol.css("cursor", "url(/gallery/lhp_miv/cursorHand.png),default")
        }
    };
    d.prototype.mousedownHandler = function (l) {
        ...
        m.$contentHol.css("cursor", "url(/gallery/lhp_miv/cursorDrag.png), move");
        l.preventDefault()
    };
    ...
    d.prototype.mouseupHandler = function (l) {
        ...
        m.$contentHol.unbind("mouseup.lhpMIV", m.positioning);
        if (!m.sett.testMode) {
            m.$contentHol.css("cursor", "url(/gallery/lhp_miv/cursorHand.png),default")
        } else {
    ...
    b.prototype.mouseenterHandler = function (l) {
        l.data._this.$vr.css("cursor", "url(/gallery/lhp_miv/cursorHand.png),default")
    };
    b.prototype.mousedownHandler = function (l) {
        ...
        m.lastMousePageCoor = m.mousePageCoor(l);
        m.$vr.css("cursor", "url(/gallery/lhp_miv/cursorDrag.png), move").addClass("lhp_miv_map_vr_over");
        l.preventDefault()
    };
    ...
    b.prototype.mouseupHandler = function (l) {
        ...
        m.$vr.css("cursor", "url(/gallery/lhp_miv/cursorHand.png),default").removeClass("lhp_miv_map_vr_over")
    };
